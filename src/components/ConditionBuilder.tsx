...
export function ConditionBuilder({
  ...
  const [condType, setCondType] = useState<"min_attendees" | "specific_user">(
    "min_attendees",
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg p-3 space-y-3">
        ...
        <Select
          value={condType}
          onValueChange={(v) => setCondType(v as typeof condType)}
        >
          ...
          <SelectContent>
            <SelectItem
              ...
              disabled={conditions.some(
                (c) => c.condition_type === "min_attendees",
              )}
            >
              At least N people are going
            </SelectItem>
            <SelectItem value="specific_user">
              A specific person is going
            </SelectItem>
          </SelectContent>
        </Select>
